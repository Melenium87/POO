...
public class TareaEj13 implements Comparable<TareaEj13>
{
    ...
    public TareaEj13(String titulo, String descripcion, int prioridad)
    {
        this.titulo=titulo;
    ...
    public TareaEj13(String titulo, String descripcion, int prioridad, LocalDate fechaLimite)
    {
        this.titulo=titulo;
        this.descripcion=descripcion;
        this.prioridad=prioridad;
    ...
    public TareaEj13(String titulo, String descripcion, int prioridad, LocalDate fechaLimite, LocalDate recordatorio)
    {
        this.titulo=titulo;
        this.descripcion=descripcion;
        this.prioridad=prioridad;
    ...
    public void modificarTarea(Colaborador col)
    {
        opciones();
    ...
    public void marcarTermida(Colaborador co)
    {
        estado=2;
        co.sumarProyecto();
        colaborador=co;
    ...
    @Override
    public int compareTo(@NotNull TareaEj13 o) {
