...
public class Secretaria {
    ...
    public void darAltaComision(String disciplina, String horario, String salon, String nivel, String dniProfesor){
        ...
        if (d!=null){
            ...
            if (s!=null){
                ...
                if (prof!=null){
                    d.crearComision(horario,prof,nivel,s);
